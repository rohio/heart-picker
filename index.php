        ...
        <div class="wrapper">
            <div class="container">
                ...
                <form class="form" action="heart.php" method="post">
                    ...
                    <input type="text" name="begin_date" placeholder="例: 2015-1-1" id="begin_date" pattern="201[0-9][/-]([1-9]|0[1-9]|1[12])[/-]([1-9]|[0-2][1-9]|3[01])">

                    <label for="end_date" accesskey="n"><font size="4">日付指定(終了日)　</font><font size="3">任意</font><br>
                    <font size="2" color="lightcyan">Year-Month-Dayの形式で指定してください</font></label>
                    <input type="date" name="end_date" placeholder="例: 2016-1-31" id="end_date">
